      ...
      <header className="w-full border-b border-stone-200/80 dark:border-stone-800/80 bg-white/70 dark:bg-stone-900/70 backdrop-blur-md sticky top-0 z-30 transition-colors">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* GitHub Repo */}
            <a
              href="https://github.com/ABHIjeet6262/orbital-year-tracker"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 text-stone-600 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 rounded-xl transition-colors hidden sm:flex items-center gap-1.5 text-xs font-medium cursor-pointer"
